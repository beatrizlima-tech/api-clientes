...
public class ClienteRepository {
    ...
    public void inserir(Cliente cliente) throws Exception{
        ...
        // Escrever o comando SQL que vai ser executado no banco de dados
        var sql = """
    ...
    public boolean atualizar(Cliente cliente) throws Exception{
        ...
        // Fechadno a conexão com o banco
        connection.close();
    ...
    // Método para retornar uma lista com todos os clientes obtidos no banco de dados
    public List<Cliente> obterPorNome(String nome) throws Exception{

        // Escrever o comando SQL que será executado no banco
        var sql = """
        ...
        while(result.next()) {
            ...
            lista.add(cliente); // Adicionando cliente na lista
